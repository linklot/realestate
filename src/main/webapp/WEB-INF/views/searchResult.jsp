...
<head>
  ...
  <title>Search Result - NewAD - Real Estate</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div id="content" class="col-lg-7 col-md-6 col-sm-6 col-xs-12 clearfix">
        ...
        <div class="property_wrapper img_list_box boxes clearfix">
          <div class="title clearfix">
            <h3><a href='/property/<c:out value="${prop.id}"/>' target="_blank"> <c:out value="${prop.feature}"/></a> 
              <small class="small_title"><c:out value="${prop.address}"/></small>
            </h3>
          </div><!-- end title -->

          <div class="ImageWrapper boxes_img">
            <img class="img-responsive" src="/static/propertyPic/<c:out value="${prop.firstPicId}"/>" alt="">
            <div class="box_type">$A <c:out value="${prop.price}"/></div>
            <div class="status_type"><c:out value="${prop.newOrEstablished}"/></div>
          </div><!-- ImageWrapper -->

          <div class="boxed_mini_details1 col-md-8 clearfix search_details">
            <span class="type first"><strong>类型</strong><c:out value="${prop.propertyType}"/></span>
            <span class="sqft"><strong>面积 m<sup>2</sup></strong><c:out value="${prop.landSize}"/></span>
            <span class="bedrooms"><strong>卧室</strong><c:out value="${prop.beds}"/></span>
            <span class="status"><strong>浴室</strong><c:out value="${prop.bathrooms}"/></span>
            <span class="garage"><strong>车位</strong><c:out value="${prop.carSpaces}"/></span>
          </div><!-- end boxed_mini_details1 -->

          <div class="property_desc clearfix">
            <a class="btn btn-primary btn-xs" href='/property/<c:out value="${prop.id}"/>' title="详 细" target="_blank"> 详 细 </a>
          </div>
