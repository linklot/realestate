...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><c:out value="${column.name}"/> - NewAD | Real Estate</title>
        ...
        <div class="property_wrapper boxes clearfix topic_list">
          <ul>
            ...
            <li><i class="fa fa-info-circle"></i>
              <a href='/topic/<c:out value="${topic.id}"/>' target="_blank"><c:out value="${topic.title}"/></a>
              <span class="time"><c:out value="${topic.readableTime}"/></span>
            </li>
            </c:forEach>
          </ul>
